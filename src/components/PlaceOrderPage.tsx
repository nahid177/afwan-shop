...
const PlaceOrderPage: React.FC = () => {
  ...
  const { cartItems, clearCart } = useCart(); // Removed totalAmount
  ...
  const handlePromoCodeValidation = async () => {
    ...
    try {
      ...
      console.error("Error validating promo code:", error); // Added error logging
  ...
  return (
    <ThemeProvider>
      <div
        className={`lg:p-24 min-h-screen p-6 ${
